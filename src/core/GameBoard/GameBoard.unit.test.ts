...
describe(GameBoard.name, () => {
  let gameBoard: GameBoard;
  beforeEach(() => {
    gameBoard = createGameBoard();
  });
  describe(GameBoard.prototype.addFood.name, () => {
  ...
  describe(GameBoard.prototype.addSnakeBodyPart.name, () => {
  ...
  describe(GameBoard.prototype.isFoodPosition.name, () => {
    ...
    test('should NOT return true if position is not a food position', () => {
      expect(gameBoard.isFoodPosition({ x: 1000, y: 1000 })).toBeFalsy();
    });
  });
  describe(GameBoard.prototype.isGameOver.name, () => {
  ...
  describe(GameBoard.prototype.isTopWall.name, () => {
  ...
  describe(GameBoard.prototype.removeFood.name, () => {
  ...
  describe(GameBoard.prototype.removeSnakeBodyPart.name, () => {
  ...
  describe(GameBoard.prototype.reset.name, () => {
  ...
  describe(GameBoard.prototype.updateBoard.name, () => {
...
function createGameBoard(): GameBoard {
  return new GameBoard({ foodCount: 2, columnsCount: 4, rowsCount: 4 });
}
